...
# 🎮 Master Of Pottery — Community Edition

**Shape, glaze, and sell handcrafted pottery in a relaxing studio simulation.**
...
Master Of Pottery is a relaxing crafting simulation in which players shape clay on a pottery wheel, glaze and paint their creations, and sell them to grow a personal studio. This Community Edition is a standalone build distributed as a self-contained package. It includes all content, requires no storefront, and is ready to play immediately after installation.

Players who enjoy calm crafting and simulation games and want a complete offline version that runs on any modern PC.
...
<table>
 <tr>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/1160490/ss_d27008911533606e3cd1ba74e6372f43b254e41c.1920x1080.jpg?t=1789099983" alt="Screenshot 1" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/1160490/ss_70d43b4c7b9819cd537415d4a567a2e8c413a719.1920x1080.jpg?t=1789099983" alt="Screenshot 2" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/1160490/ss_175b9d71332d1350a842df1d8fc3add26bf213b1.1920x1080.jpg?t=1789099983" alt="Screenshot 3" width="100%"></td>
 </tr>
</table>
...
- 🏺 **Pottery Wheel Shaping** — Mold clay into vases, bowls, plates, and teapots with intuitive wheel controls.
- 🎨 **Glazing and Painting** — Apply glazes, colors, and brush patterns to finish each unique piece.
- 🏪 **Studio Management** — Display and sell your work to earn funds and expand your workshop.
- 🌿 **Relaxing Gameplay** — No timers or fail states — craft at your own pace in a calm environment.
- 📦 **Self-Contained Package** — Standalone build with no additional software required.
- ⚡ **Ready to Play** — Install and start crafting immediately — includes all content.
- 🖥️ **Lightweight Build** — Runs smoothly on modest hardware, including integrated graphics.
- 🌐 **Multiple Languages** — Interface localized in English, Chinese, Japanese, and Korean.

- **Compression:** Lossless
- **Install Time:** ~2 minutes on SSD, ~5 minutes on HDD
- **Recoding:** none
- **Selective Download:** Nothing — complete package included
...
| **RAM** | 4 GB | 8 GB |
| **Graphics** | Intel HD Graphics 4000 or DirectX 11 compatible GPU | NVIDIA GeForce GTX 750 or better |
| **Storage** | 2 GB available space | 2 GB available space on SSD |
| **Additional** | Mouse required | Mouse or drawing tablet for precise shaping |
...
> 💡 **Saves location:** `%LOCALAPPDATA%\MasterOfPottery\Saved`
